...
ROOT = os.environ.get("BEVLANE_ROOT",
                      "data/t4dataset")
PROD = "out/production"
# Output root can be overridden via env var (2026-08-16): lets downstream generation
# (gt_cons etc.) run while a new corpus lives on a different disk.
...
# R program (2026-08-30): stored resolution switchable via env. Default 768x432 is
# 1/5 of the 4K source (3840x2160). The full-res pilot uses 1536x864 (1/2.5).
